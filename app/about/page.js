  ...
  return (
    <div className='light'>
      ...
      <section>
        ...
        <Container className='container-fluid d-flex justify-content-center align-items-center' style={{ height: "100vh" }}>

          <div className="card card2">
            <Image src='/assets/space.png' width={200} height={200} className='spaceship'></Image>
            <div className="card-body">
              <h5 className="card-title">About Me</h5>
              <p className="card-text mt-4 text-center desc" style={{ height: "100px", fontSize: "18px" }}>Hello and welcome to my portfolio! I&apos;m <b> John Paul Orencio</b>, a not so passionate software developer with no knack for creating elegant and efficient solutions whatsoever.
