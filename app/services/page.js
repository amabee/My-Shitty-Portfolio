      ...
      <section>
        ...
        <header className='header'>
          ...
          <nav className='navbar'>
            ...
            <Link className='links btn-container' href={"/about"}>
              <div className="svg svg-1">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" height="40px" width="40px">
        ...
        <section className="container">
          ...
          <section className="card__container">
            <div className="card__bx card__1 customCard card2">
              <div className="card__data">
                ...
                <div className="card__content">
                  ...
                  <p>Design and develop responsive and user-friendly websites using modern technologies like HTML, CSS, JavaScript, and frameworks such as React, Angular, or Vue.js</p>

                </div>
              </div>
            </div>
            <div className="card__bx card__2 customCard card2">
              <div className="card__data">
                <div className="card__icon">
                  <div className="card__icon-bx"><i className="bi bi-pen"></i></div>
                </div>
                <div className="card__content">
                  <h3>UI/UX Design and Prototyping</h3>
                  <p>Create intuitive and visually appealing user interfaces that enhance user experience.</p>
                </div>
              </div>
            </div>
            <div className="card__bx card__3 customCard card2">
              <div className="card__data">
                <div className="card__icon">
                  <div className="card__icon-bx"><i className="bi bi-unlock"></i></div>
                </div>
                <div className="card__content">
                  <h3>Account Recovery Assistance</h3>
                  <p>Provide support for recovering compromised accounts, including social media, email, and other online services.
                  </p>
                </div>
              </div>
            </div>
