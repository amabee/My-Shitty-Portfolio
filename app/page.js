            ...
            <Col className='sec1 d-flex justify-content-center align-items-center'>
              <div className="card customCard glass-card" style={{ width: "30rem" }}>
                ...
                <div className="card-body">
                  ...
                  <p className="card-text mt-4 text-center desc">Hello and welcome to my portfolio! Im <b>John Paul Orencio</b>, a passionate software developer with a knack for creating elegant and efficient solutions. My journey in technology has been fueled by a deep curiosity and a drive to continuously learn and innovate.
                  </p>
                </div>
              </div>
            </Col>
