                ...
                <section>
                    ...
                    <section className="design-section">
                        <div className="timeline">
                            ...
                            <div className="timeline-component timeline-content card2 customCard">
                                <h3 className='logo'>Current</h3>
                                <p>Attended Cagayan de Oro College PHINMA for College in BSIT</p>
                            </div>


                            <div className="timeline-component timeline-content card2 customCard">
                                <h3 className="logo">2016-2018</h3>
                                <p>Attended St Mary's Academy of Carmen in Senior Highschool</p>
                            </div>
                            ...
                            <div className=" timeline-component timeline-content card2 customCard">
                                <h3 className='logo'>2012-2016</h3>
                                <p>Attended St Mary's Academy of Carmen in Junior Highschool</p>
                            </div>
                            ...
                            <div className="timeline-middle">
                                <div className="timeline-circle" style={{marginLeft:"-2.5px"}}></div>
                            </div>
                            <div className=" timeline-component timeline-content card2 customCard">
                                <h3 className='logo'>2005-2012</h3>
                                <p>Attended City Central School in Elementary</p>
                            </div>
